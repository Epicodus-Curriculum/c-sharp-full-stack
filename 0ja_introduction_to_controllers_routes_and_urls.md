...
The `Hello()` method represents a **route** in our application. As we discussed in the [Uniform Resource Locators (URLS)](/c-and-net/basic-web-applications-part-2/how-the-web-works-uniform-resource-locator) lesson:
