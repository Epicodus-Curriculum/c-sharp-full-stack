...
Before we can discuss what server-side means, we must first understand the difference between a client and a server. We covered this in the [_How the Web Works: Clients and Servers_](/c-and-net/basic-web-applications-part-2/how-the-web-works-clients-and-servers) lesson; but let's quickly review.
...
(If any of this feels unclear, we recommend revisiting and reviewing the [_How the Web Works: Clients and Servers_](/c-and-net/basic-web-applications-part-2/how-the-web-works-clients-and-servers) lesson before advancing.)
