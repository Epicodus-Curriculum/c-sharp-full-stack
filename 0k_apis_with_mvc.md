...
If you create your MVC app from scratch, follow along with the basic structure for an ASP.NET Core MVC app outlined [in this LearnHowToProgram.com lesson](/c-and-net/basic-web-applications-part-2/configuration-quick-reference). The directory name for our project will be `MvcApiCall`. 
